...
اگر بخواهیم صفر ها را به ابتدای آرایه بیاوریم چه؟ برای انتقال صفرها به ابتدای آرایه همراه با حفظ ترتیب نسبی اعداد غیرصفر، باید جهت پیمایش و چیدمان را معکوس کنید؛ یعنی از انتها به ابتدا (راست به چپ) پیمایش کنید و اعداد غیرصفر را به سمت راست بفرستید:
```
#include <iostream>
#include <vector>
#include <algorithm>
